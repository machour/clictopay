...
class Container_dcae8a3458 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_dcae8a3458 $container)
			{
	...
	public function createServiceContainer(): Container_dcae8a3458
	{
		return $this;
	}
