...
// source: /Users/didou/dev/machour/clictopay/vendor/phpstan/extension-installer/src/../../../nesbot/carbon/extension.neon
...
class Container_7137ce89d4 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.methodsClassReflectionExtension' => ['0729' => true],
	];
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['0694', '0697', '0699', '0700', '0729']],
		...
		'Carbon\PHPStan\MacroExtension' => [['0729']],
	];
	...
	public function createService064(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/Users/didou/dev/machour/clictopay/vendor/nesbot/carbon/extension.neon',
	...
	public function createService0364(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			[
				'phar:///Users/didou/dev/machour/clictopay/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'/Users/didou/dev/machour/clictopay/vendor/phpstan/extension-installer/src/../../../nesbot/carbon/extension.neon',
				'/Users/didou/dev/machour/clictopay/phpstan.neon',
			],
			$this->getParameter('analysedPaths'),
			['/Users/didou/dev/machour/clictopay'],
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_7137ce89d4 $container)
			{
	...
	public function createService0729(): Carbon\PHPStan\MacroExtension
	{
	...
	public function createServiceContainer(): Container_7137ce89d4
	{
		return $this;
	}
